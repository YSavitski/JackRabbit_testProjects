...
public class Util {
    public static final String PATH_REPOSITORY = System.getProperty("user.dir")+"\\testRepository";
    public static final File directory = new File(PATH_REPOSITORY);
    ...
    static {
        ...
        CREDS.add(buildCreds("username1", "username1"));
        CREDS.add(buildCreds("username2", "username2"));
    }
